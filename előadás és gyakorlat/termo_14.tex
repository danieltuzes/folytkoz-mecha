...
\end{align}
vagyis egyensúlyban a szabadenergiának van minimuma. Most a hőtartállyal való kapcsolatot vettük figyelembe. További néhány lehetőséget \aref{tab:egyensuly}.\ táblázatban foglalunk össze.
\begin{table}[htb]
\centering
