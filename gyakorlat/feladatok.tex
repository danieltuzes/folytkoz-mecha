...
\[{\mathbf{\sigma }}\left( {\mathbf{r}} \right) = c \left( {\begin{array}{*{20}{c}}
  ...
  0&0&{{z}} 
\end{array}} \right).\]
A kocka minden pontjában a sűrűséggel arányos, a térben nem feltétlen homogén tömegerő hat. Hat valamint minden oldallapra külön-külön állandó nagyságú és irányú felületi erő. Mekkora nagyságú és irányú
\begin{enumerate}
\item tömegerő hat a kockára?
