...
Egy szögletes, alul vízszintes, oldalt függőleges szárú, U alakú, két végén nyitott csőben folyadék van (lásd \aref{fig:ucsoves}.\ ábrát). A csövet az U egyik szára tengelyében állandó $\omega$ szögsebességgel forgatjuk. Milyen alakú lesz az U két szárában a vízoszlop $\omega$ függvényében?

\begin{figure}[htb] 
\centering    
\includegraphics[scale=1]{figs/bernoUlli.eps}
\caption{Egy U alakú folyadék van, majd megforgatjuk az egyik szára tengelyében.}
\label{fig:ucsoves}
\end{figure}
\FloatBarrier
