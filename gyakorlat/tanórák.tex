...
\footnotesize
\paragraph{Példa}
Vízszintes áramlási cső $q_1$ és $q_2$ keresztmetszetű részeibe iktatott folyadék manométerekben a szintkülönbség $h$, ahogy azt \aref{fig:bernoulli}.\ ábrán láthatjuk. Fejezzük a másodpercenként átáramló víz mennyiségét $h$ függvényében! (Az áramlás súrlódásmentesnek és stacionáriusan tekinthetjük.) Az általános képleten túl helyettesítsünk is be konkrét számértékekkel, $q_1 = \SI{5}{cm^2}$, $q_2 = \SI{3}{cm^2}$, $h={\hat x}\,\si{cm}$
